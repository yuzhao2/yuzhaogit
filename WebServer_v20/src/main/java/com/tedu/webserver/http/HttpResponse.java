...
public class HttpResponse {
	...
	private void sendStatusLine(){
		try {
			String line = "HTTP/1.1"+" "+statusCode
...
//		String contentType = HttpContext.getMimeTypeMapping(ext);
//		headers.put("Content-Type", "cintentType");
		...
		/*headers.put("Content-Type", 
			HttpContext.getMimeTypeMapping(
